...
const urlApiUser = "http://localhost:8088/users";
const headersUser= {
    ...
    .then(function(usuario){
            ...
            if(usuario){                
                ...
                <form action="" method="post" id="modificar">
                    ...
                    <input type="text" class="form-control" name="phone" id="phone" required value="${usuario.phone}"> <br>
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" name="email" id="email" required value="${usuario.email}"> <br>
                    <!--<label for="password" class="form-label">Password</label>-->
                    <input type="hidden" class="form-control" id="password" name="password" required value="123456789"> <br>
...
function verUsuario(id){
    ...
    .then(function(usuario){
            ...
            if(usuario){                
                cadena = `
                <div class="p-3 mb-2 bg-light text-dark">
                    <h1 class="display-5"><i class="fa-solid fa-user-pen"></i> Información de Usuario</h1>
                </div>
                <ul class="list-group">
